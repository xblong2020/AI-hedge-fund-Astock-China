...
def ben_graham_agent(state: AgentState, agent_id: str = "ben_graham_agent"):
    ...
    for ticker in tickers:
        ...
        analysis_data[ticker] = {"signal": signal, "score": total_score, "max_score": max_possible_score, "current_price": current_price, "market_cap": market_cap, "earnings_analysis": earnings_analysis, "strength_analysis": strength_analysis, "valuation_analysis": valuation_analysis}
...
Reply with reasoning in Chinese (简体中文). The signal field must remain English (bullish/bearish/neutral).""",
            ),
        ]
    )
