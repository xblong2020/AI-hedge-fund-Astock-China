...
def parse_cli_inputs(
    *,
    ...
    if include_html_flag:
        parser.add_argument("--html", dest="show_html", action="store_true", help="Generate a detailed HTML report")
    ...
    return CLIInputs(
        ...
        show_html=getattr(args, "show_html", False),
        raw_args=args,
    )
